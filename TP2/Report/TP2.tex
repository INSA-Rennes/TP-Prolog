...
Les deux versions rendent sont équivalentes car, dans la première version,
le fait que C1 et C2 sont des cartes est vérifié en utilisant hauteur et couleur.
Cependant la seconde version est moins bien car l'appel à est_carte oblige l'instanciation des paramètres.
